...
class Graph implements GNode {
	...
	// this function accepts GNode vertex as a parameter and returns all the
	// vertices of a graph
...
class GraphQuestion1 {
	...
	public static void main(String[] args) {
		List<Edge> edges = Arrays.asList(new Edge(0, 1), new Edge(1, 2), new Edge(1, 3), new Edge(2, 3),
				new Edge(3, 4));
